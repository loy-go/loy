---
title: "loy make command"
description: "Scaffold CQRS write command and handler pipeline"
slug: reference/cli/loy-make-command
sidebar:
  order: 16
---


Scaffold CQRS write command and handler pipeline

```
loy make command <name> [fields...] [flags]
```
