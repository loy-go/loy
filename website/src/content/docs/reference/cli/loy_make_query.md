---
title: "loy make query"
description: "Scaffold CQRS read query and projection view"
slug: reference/cli/loy-make-query
sidebar:
  order: 36
---


Scaffold CQRS read query and projection view

```
loy make query <name> [fields...] [flags]
```
