---
title: "loy make template"
description: "Manage and eject generator templates for local project customization"
slug: reference/cli/loy-make-template
sidebar:
  order: 43
---


Manage and eject generator templates for local project customization
...
* [loy make template eject](/loy/reference/cli/loy-make-template-eject/)	 - Eject a built-in template into .loy/templates/ for local customization
* [loy make template list](/loy/reference/cli/loy-make-template-list/)	 - List all built-in templates available for override
