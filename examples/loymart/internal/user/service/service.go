...
// Service coordinates application use cases for users.
type Service struct {
...
// GetByID returns the User entity matching the given ID.
func (s *Service) GetByID(ctx context.Context, id int64) (*domain.User, error) {
	return s.repo.FindByID(ctx, id)
}

// List returns a list of User entities.
...
func (s *Service) Create(ctx context.Context, entity *domain.User) error {
	if entity == nil {
...
func (s *Service) Update(ctx context.Context, entity *domain.User) error {
	if entity == nil {
		return fmt.Errorf("entity cannot be nil")
	}
